...
dependencies=(alacritty alsa-utils arandr blueberry bspwm btop calcurse dunst feh firefox fish gtk-engine-murrine gvfs gvfs-afc gvfs-gphoto2 gvfs-mtp gvfs-nfs gvfs-smb i3-wm jq lightdm lightdm-slick-greeter lxappearance-gtk3 mpc mpd mpv ncmpcpp neofetch neovim networkmanager network-manager-applet numlockx obconf openbox pavucontrol pipewire pipewire-pulse playerctl polkit-gnome polybar ranger rofi sed sxhkd sysstat ttf-jetbrains-mono-nerd udisks2 ueberzug unrar unzip wireplumber xarchiver xbindkeys xdg-user-dirs-gtk xf86-input-libinput xf86-input-evdev xf86-video-amdgpu xf86-video-ati xf86-video-fbdev xf86-video-intel xf86-video-nouveau xf86-video-vmware xfce4-power-manager xfce4-screenshooter xorg xorg-xbacklight xorg-xdpyinfo xorg-xinit xss-lock zathura zathura-cb zathura-djvu zathura-pdf-mupdf zathura-ps zip)
...
yay -S --noconfirm betterlockscreen dragon-drop qogir-icon-theme picom-pijulius-git ttf-icomoon-feather
