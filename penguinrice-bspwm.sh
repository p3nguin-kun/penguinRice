...
yay -S --noconfirm betterlockscreen dragon-drop everforest-gtk-theme-git picom-pijulius-git pixterm-git qogir-icon-theme sddm-theme-aerial-git ttf-icomoon-feather
...
for folder in alacritty bspwm btop calcurse dunst fish gtk-3.0 gtk-4.0 mpd ncmpcpp neofetch nvim picom ranger rofi sxhkd wallpapers xfce4 zathura; do
